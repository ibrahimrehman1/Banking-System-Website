    ...
    return(
        <>
            ...
            <footer className="footer">
                ...
                <section>
                    <h6>What should you need do to get personal loan ver easay.</h6>
                    <span>20 days ago</span>
                    <p>Many modern alternatives often eumen incorpo other content actually detracts from...</p>
                    <br />
                    <br />
                    <h6>What should you need do to get personal loan ver easay.</h6>
                    <span>20 days ago</span>
                ...
                <section>
                    ...
                    <Button variant="contained" size="large" style={{backgroundColor: "#8180e0", color: "white"}}>
                        Subscribe Now
                    </Button>
                </section>
            </footer>
            <section className="copyright-section">
                <h4>Copyright <span style={{color: "#8180e0"}}>Payloan</span> All rights reserved</h4>
            </section>
        </>
